run:
    java -XX:+UseParallelGC -Dtlc.timeout=360 -jar ./thirdparty/tla2tools.jar -config MultiTypeTreePartitioningAV1_3D_QueueLoad/MultiTypeTreePartitioningAV1_3D_QueueLoad.cfg MultiTypeTreePartitioningAV1_3D_QueueLoad/MultiTypeTreePartitioningAV1_3D_QueueLoad.tla
