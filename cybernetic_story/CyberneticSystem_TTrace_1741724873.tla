---- MODULE CyberneticSystem_TTrace_1741724873 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("CyberneticSystem_TTrace_1741724873.json", _TETrace)
...
\*
\*trace == IODeserialize("CyberneticSystem_TTrace_1741724873.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([phase |-> 1,threat_level |-> 0,disposition |-> 0,location |-> ])
    >>
----
...
---- CONFIG CyberneticSystem_TTrace_1741724873 ----
CONSTANTS
    NumPhases = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Mar 11 13:27:54 PDT 2025